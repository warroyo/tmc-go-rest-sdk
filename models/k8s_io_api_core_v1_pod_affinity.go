...
// K8sIoAPICoreV1PodAffinity Pod affinity is a group of inter pod affinity scheduling rules.
//
// swagger:model k8s.io.api.core.v1.PodAffinity
...
// Validate validates this k8s io api core v1 pod affinity
func (m *K8sIoAPICoreV1PodAffinity) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *K8sIoAPICoreV1PodAffinity) validatePreferredDuringSchedulingIgnoredDuringExecution(formats strfmt.Registry) error {
...
func (m *K8sIoAPICoreV1PodAffinity) validateRequiredDuringSchedulingIgnoredDuringExecution(formats strfmt.Registry) error {
...
// ContextValidate validate this k8s io api core v1 pod affinity based on the context it is used
func (m *K8sIoAPICoreV1PodAffinity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *K8sIoAPICoreV1PodAffinity) contextValidatePreferredDuringSchedulingIgnoredDuringExecution(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sIoAPICoreV1PodAffinity) contextValidateRequiredDuringSchedulingIgnoredDuringExecution(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sIoAPICoreV1PodAffinity) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *K8sIoAPICoreV1PodAffinity) UnmarshalBinary(b []byte) error {
	var res K8sIoAPICoreV1PodAffinity
