...
// K8sIoAPICoreV1PodAntiAffinity Pod anti affinity is a group of inter pod anti affinity scheduling rules.
//
// swagger:model k8s.io.api.core.v1.PodAntiAffinity
type K8sIoAPICoreV1PodAntiAffinity struct {
	...
	// +optional
	PreferredDuringSchedulingIgnoredDuringExecution []*K8sIoAPICoreV1WeightedPodAffinityTerm `json:"preferredDuringSchedulingIgnoredDuringExecution"`
	...
	// +optional
	RequiredDuringSchedulingIgnoredDuringExecution []*K8sIoAPICoreV1PodAffinityTerm `json:"requiredDuringSchedulingIgnoredDuringExecution"`
}

// Validate validates this k8s io api core v1 pod anti affinity
func (m *K8sIoAPICoreV1PodAntiAffinity) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *K8sIoAPICoreV1PodAntiAffinity) validatePreferredDuringSchedulingIgnoredDuringExecution(formats strfmt.Registry) error {
...
func (m *K8sIoAPICoreV1PodAntiAffinity) validateRequiredDuringSchedulingIgnoredDuringExecution(formats strfmt.Registry) error {
...
// ContextValidate validate this k8s io api core v1 pod anti affinity based on the context it is used
func (m *K8sIoAPICoreV1PodAntiAffinity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *K8sIoAPICoreV1PodAntiAffinity) contextValidatePreferredDuringSchedulingIgnoredDuringExecution(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sIoAPICoreV1PodAntiAffinity) contextValidateRequiredDuringSchedulingIgnoredDuringExecution(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sIoAPICoreV1PodAntiAffinity) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *K8sIoAPICoreV1PodAntiAffinity) UnmarshalBinary(b []byte) error {
	var res K8sIoAPICoreV1PodAntiAffinity
