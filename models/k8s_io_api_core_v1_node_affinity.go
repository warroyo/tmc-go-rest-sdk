...
// K8sIoAPICoreV1NodeAffinity Node affinity is a group of node affinity scheduling rules.
//
// swagger:model k8s.io.api.core.v1.NodeAffinity
type K8sIoAPICoreV1NodeAffinity struct {
	...
	// +optional
	PreferredDuringSchedulingIgnoredDuringExecution []*K8sIoAPICoreV1PreferredSchedulingTerm `json:"preferredDuringSchedulingIgnoredDuringExecution"`
...
// Validate validates this k8s io api core v1 node affinity
func (m *K8sIoAPICoreV1NodeAffinity) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *K8sIoAPICoreV1NodeAffinity) validatePreferredDuringSchedulingIgnoredDuringExecution(formats strfmt.Registry) error {
...
func (m *K8sIoAPICoreV1NodeAffinity) validateRequiredDuringSchedulingIgnoredDuringExecution(formats strfmt.Registry) error {
...
// ContextValidate validate this k8s io api core v1 node affinity based on the context it is used
func (m *K8sIoAPICoreV1NodeAffinity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *K8sIoAPICoreV1NodeAffinity) contextValidatePreferredDuringSchedulingIgnoredDuringExecution(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sIoAPICoreV1NodeAffinity) contextValidateRequiredDuringSchedulingIgnoredDuringExecution(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8sIoAPICoreV1NodeAffinity) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *K8sIoAPICoreV1NodeAffinity) UnmarshalBinary(b []byte) error {
	var res K8sIoAPICoreV1NodeAffinity
